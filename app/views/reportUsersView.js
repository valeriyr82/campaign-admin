...
define([
	...
	'underscore',
	'backbone',
	'text!templates/report_users.html',
], function ($, jqueryui, _, Backbone,  reportUsersTemplate) { // later ReportCollection, reportRowTemplate,
	'use strict';
	var locationpiedata = [];
	var pushpiedata = [];
	var genderpiedata = [];
	...
	var ReportView = Backbone.View.extend({
        ...
        el: '.content',
		template: _.template(reportUsersTemplate),
        events: {
		},
		initialize: function () {
