...
define([
	...
	'underscore',
	'backbone',
	'text!templates/report_history.html',
], function ($, jqueryui, _, Backbone,  reportHistoryTemplate) { // later ReportCollection, reportRowTemplate,
	'use strict';
	var locationpiedata = [];
	var pushpiedata = [];
	var genderpiedata = [];
	...
	var ReportView = Backbone.View.extend({
        ...
        el: '.content',
		template: _.template(reportHistoryTemplate),
        events: {
